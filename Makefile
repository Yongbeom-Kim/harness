...
build:
	cd orchestrator && go build -o ../bin/t_codex cmd/codex/main.go
	cd orchestrator && go build -o ../bin/t_claude cmd/claude/main.go
	cd orchestrator && go build -o ../bin/t_agent cmd/agent/main.go
